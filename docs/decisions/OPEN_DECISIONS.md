...
| OD-05 | Limit pobrań — anonimowy | Download limits (wartość startowa) |
| OD-06 | Limit pobrań — zalogowany | Download limits (wartość startowa) |
...
| OD-13 | Watermarking audio | Download pipeline |
...
| OD-17 | Liczenie powtórnych pobrań | Download stats / limity |
